        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                       /* .requestMatchers("/**").permitAll()*/ // This line allows access to all paths
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/group/getAllPostsWithGroupId/{id}").hasRole(Constrains.ROLE_ADMIN)
                        .requestMatchers(HttpMethod.GET, "/api/v1/group/getAllUsersWithGroupId/{id}").hasRole(Constrains.ROLE_ADMIN)
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/post/getAllInteraction/{id}").hasAnyRole(Constrains.ROLE_ADMIN,Constrains.ROLE_USER)
